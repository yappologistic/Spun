...
MenuItem {
    ...
    // Keep the MenuItem itself alive for action routing and keyboard navigation.
    // Visuals live through the exit transition, then release their bindings/textures.
    background: Loader { active: entry.visible; sourceComponent: Rectangle {
    ...
    contentItem: Loader { active: entry.visible; sourceComponent: Item {
